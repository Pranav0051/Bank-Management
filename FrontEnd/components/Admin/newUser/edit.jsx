...
const handelEditUser = (User, form, refreshList) => {
      ...
      <form id="editUserForm">
        ...
        <table class="User-table">
          ...
          <tr>
            ...
            <td><input type="text" class="form-control" id="firstname" name="firstname" value="${User.firstname}" required /></td>
          </tr>

          <tr>
            <td class="form-label">Last Name:</td>
            <td><input type="text" class="form-control" id="lastname" name="lastname" value="${User.lastname}" required /></td>
          </tr>

          <tr>
            <td class="form-label">Phone:</td>
            <td><input type="text" class="form-control" id="phone" name="phone" value="${User.phone}" required /></td>
          </tr>
          ...
          <tr>
            ...
            <td><input type="text" class="form-control" id="loginId" name="loginId" value="${User.loginId}" required /></td>
          </tr>

          <tr>
            <td class="form-label">Password:</td>
            <td><input type="password" class="form-control" id="password" name="password" value="${User.password}" required /></td>
          </tr>

          <tr>
            <td class="form-label">Address:</td>
            <td><input type="text" class="form-control" id="address" name="address" value="${User.address}" required /></td>
          </tr>
